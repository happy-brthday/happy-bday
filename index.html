...
<body>
  <div class="img-back">
    ...
    <div id="rocket">
      <img src="img/rocket_big.png" alt="rocket-image"/>
    </div>
    <a class="glow-on-hover" id="launch" href="javascript:void(0);">Launch &#60;/&#62;</a>
  </div>
  <div class="container">
    <div class="one">
      <h1 class="one">Hey
    ...
    <div class="nine">
      <p>Okay, Now a lil Surprise ahead</p>
  ...
  <div id="card">
		<div id="card-inside">
			<div class="wrap">
				<center><p class="bday-title"><b>Happy Birthday Anjali!</b></p><center>
					<p> Hey Boo, I know I have been a terrible boyfriend so I decided I would wish you in a way, that I know the best - Code. &nbsp;<i class="em-svg em-blush"></i></p>
					<p> Happiest Birthday momo and I love you so so so much, I wish the best for you and thanks for being there for me and for making me a better person.
					I am so lucky to have you in my life. It took fucking so many lines of code to make this haha, I love you chubby cheeks and enjoy your day. Muah</p><p class="signed">Made With </b><b> <i class="em-svg em-heart"></i></p>
					</div>
				</div>
				<div id="card-front">
					<div class="wrap">
						<h1 class="animated infinite swing">HBD 2020 Booo!</h1>
          ...
          <!-- <button  data-balloon="Click to Open Card!" data-balloon-length="medium" data-balloon-pos="left" data-balloon-visible>&gt;</button> -->
          <div class="click-info">Click on Heart!!!</div>
          <div class="heart-wrap">
            <a href="javascript:void(0);" id="open" onclick="playVid()" class="heart"></a>
          </div>
          <div></div>
					...
					<div class="card-front_inside">
						<br> <br> <br>
						<div class="polaroid">
              <video id="myVideo" loop="true" controls="controls">
  ...
  <input id="audIp" type="button" value="PLAY" onclick="audPlay()" style="display:none;">
